...
class SedanBuilder(CarBuilder):
    def build_engine(self):
        self.car.set_engine(Engine("1.6 л 16 Valve. (106 л.с.)"))

    def build_transmission(self):
        self.car.set_transmission(Transmission("Механической, 5-ступенчатой переднеприводной"))
...
class SUVBuilder(CarBuilder):
    def build_engine(self):
        self.car.set_engine(Engine("2.5 DOCH (195 л. с.)"))

    def build_transmission(self):
        self.car.set_transmission(Transmission("Автоматической, 6-ступенчатой полноприводной"))
...
class SportsCarBuilder(CarBuilder):
    def build_engine(self):
        self.car.set_engine(Engine("5.5 TwinTurbo, (700+ л. с.)"))

    def build_transmission(self):
        self.car.set_transmission(Transmission("Секвинтальной, 7-ступенчатой заднеприводной"))

    def build_body(self):
        self.car.set_body(Body("Спорткар"))
